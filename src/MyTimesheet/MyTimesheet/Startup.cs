...
namespace MyTimesheet
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = @"Server=sql101labs1793591179000.westeurope.cloudapp.azure.com;Database=sql101.keoabetswe.morake;User Id=keoabetswemorake;Password=Un@wareofl0ss;";
