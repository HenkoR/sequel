...
namespace MyTimesheet.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public EmployeeController(EmpContext context, IConfiguration config)
        {
            _db = context;
            _config = config;
        }
        ...
        // GET api/values
        [HttpGet]
        public async Task<ActionResult<IEnumerable<EmpDetails>>> Get()
        {
        ...
        // GET api/values/5
        [HttpGet("{id}")]
        public async Task<ActionResult<EmpDetails>> Get(int id)
        {
